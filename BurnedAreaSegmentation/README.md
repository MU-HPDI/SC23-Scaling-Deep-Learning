...
The pipeline consists of 6 steps for which the yml files are saved in [canada_2019_sentinel_pipeline](./SC23-Scaling-Deep-Learning/BurnedAreaSegmentation/canada_2019_sentinel_pipeline) folder:
